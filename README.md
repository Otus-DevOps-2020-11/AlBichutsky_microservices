...
- Создал инстанс в Yandex Cloud c помощью docker-machine:
...
docker-machine create \
  --driver generic \
  --generic-ip-address=84.252.128.105 \
  --generic-ssh-user yc-user \
  --generic-ssh-key ~/.ssh/id_rsa \
  logging
```
...
- Запушил собранные образы `reddit` в docker-hub
...
docker_fluentd_1         tini -- /bin/entrypoint.sh ...   Up      0.0.0.0:24224->24224/tcp,:::24224->24224/tcp, 0.0.0.0:24224->24224/udp,:::24224->24224/udp, 5140/tcp
